...
public abstract class Move {
    ...
    public static class PawnPromotion extends PawnMove{
        ...
        public boolean equals(Object o){
            ...
            &&Objects.equals(promotedPawn,that.promotedPawn)&&Object.equals(promotionPiece,that.promotionPiece);
        }
        @Override
        public int hashCode(){
    ...
    public static class PawnEnPassantAttack extends PawnAttackMove{
        public PawnEnPassantAttack(final Board board,final Piece pieceMoved,
        ...
        @Override
        public Board undo(){
            final Board.Builder= new Builder();
            this.board.getAllPieces().forEach(builder::setPiece);
    ...
    static abstract class CastleMove extends Move{
        ...
        public Board execute(){
            ...
            builder.setPiece(this.movedPiece.movePiece(this));
            builder.setPiece(new Rook(this.castleRook.getPiecesAllegiance(),this.castleRookDestination,false));
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance());
            builder.setMoveTransition(this);
            return builder.build();
        }
