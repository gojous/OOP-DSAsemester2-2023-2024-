...
public class AlphaBetaWithMoveOrdering implements MoveStrategy {
    ...
    public Move execute(final Board board){
        ...
        System.out.println(boad.currentPlayer() + " THINKING with depth = " + this.searchDepth);
        ...
        for(final Move move:this.moveSorter.sort(board.currentPlayer().getLegalMoves())){
            ...
            if(moveTransition.getMoveStatus().isDone()){
                ...
                System.out.println("\t"+toString()+" analyzing "+move+"("+moveCounter+"/"+numMoves+") took "+((System.nanoTime()-candidateMoveStartTime/1000000)+"ms"));
